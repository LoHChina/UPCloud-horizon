...
def set_metadata(request, volume, metadata):
    return cinderclient(request).volumes.set_metadata(volume, metadata)


def update_all_metadata(request, volume, metadata):
    return cinderclient(request).volumes.update_all_metadata(volume, metadata)
