...
from openstack_dashboard.contrib.custom.content.project.instances \
    import views as contrib_views
...
urlpatterns = patterns(
    ...
    url(r'^(?P<instance_id>[^/]+)/$',
        contrib_views.DetailView.as_view(), name='detail'),
...
urlpatterns += patterns(
    VIEW_MOD,
    url(INSTANCES % 'measurements', contrib_views.MesurementsView.as_view(),
        name='measurements'),
)
